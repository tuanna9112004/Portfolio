  ...
  return (
    <>
      <div className='relative overflow-hidden lg:overflow-visible'>
        ...
        >
          I design and build websites end to end — from the layout, type, and
          motion someone actually sees, down to the Laravel backend running
          underneath it. I care about interfaces that feel considered rather
          than templated, and about code that's still easy to work with long
          after launch.
        </motion.p>
